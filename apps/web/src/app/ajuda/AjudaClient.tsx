...
const TOP_ARTICLES = [
  {
    title: 'Como criar minha conta no Cifrinho',
    categorySlug: 'conta',
  ...
  {
    title: 'Como categorizar uma transação',
  ...
  {
    title: 'Como importar comprovantes para o IR',
    categorySlug: 'ir',
  ...
  {
    title: 'O que são badges e como desbloqueá-las',
  ...
  {
    title: 'Diferença entre conta pessoal e empresarial',
    categorySlug: 'financas',
    category: 'Finanças pessoais',
    views: 2450,
    color: '#3B82F6',
  ...
  {
    title: 'Quais deduções o Cifrinho calcula automaticamente',
    categorySlug: 'ir',
    category: 'Imposto de Renda',
    views: 1980,
    color: '#8B5CF6',
  ...
  {
    title: 'Como mudar de plano ou cancelar',
    categorySlug: 'planos',
    category: 'Planos',
    views: 1645,
    color: '#EC4899',
...
export default function AjudaClient({ categories }: Props) {
  ...
  return (
    ...
    >
      {/* NAVEGAÇÃO */}
      <header
        className="sticky top-0 z-50 border-b border-line/70 bg-bg/80 backdrop-blur-xl"
      ...
      >
        <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 sm:px-8">
          <Link href="/" className="flex items-center gap-2.5">
            ...
            />
            <span className="text-lg font-extrabold tracking-tight" style={{ color: '#F9FAFB' }}>
              Cifrinho
            </span>
          </Link>
      ...
      <section className="relative overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              'linear-gradient(to right, rgba(31,41,55,0.4) 1px, transparent 1px), linear-gradient(to bottom, rgba(31,41,55,0.4) 1px, transparent 1px)',
          ...
          <div className="mb-8 flex items-center justify-between">
            ...
            {activeCategory && activeCat && (
              <button
                ...
                style={{
                  borderColor: activeCat.color + '50',
              ...
              return (
                ...
                >
                  <div
                    ...
                    style={{
                      backgroundColor: isActive ? cat.color + '25' : cat.bg,
                      color: cat.color,
                    }}
                  >
      ...
      {!hideStaticSections && (
        <section
          ...
          style={{ borderColor: '#1F2937', backgroundColor: 'rgba(17,24,39,0.4)' }}
        >
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {filteredArticles.map((article, i) => (
                  <a
                    ...
                    onMouseEnter={(e) => {
                      ;(e.currentTarget as HTMLAnchorElement).style.borderColor = '#374151'
                    }}
                    onMouseLeave={(e) => {
        ...
        {filteredFaqs.length > 0 ? (
          ...
          >
            ...
            <p className="mt-1 text-sm" style={{ color: '#9CA3AF' }}>
              Tente outros termos ou entre em contato com a gente.
            </p>
            <button
              onClick={clearFilters}
      ...
      <footer className="border-t" style={{ borderColor: '#1F2937' }}>
        <div
          className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-5 py-8 text-sm sm:flex-row sm:px-8"
          style={{ color: '#9CA3AF' }}
        >
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="mailto:suporte@cifrinho.app" className="transition-colors hover:text-white">
              Contato
            </a>
          </div>
        </div>

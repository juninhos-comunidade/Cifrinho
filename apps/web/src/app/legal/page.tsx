      ...
      <div className="mx-auto max-w-4xl px-5 py-16 sm:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-mute">
            Aqui explicamos claramente como usamos seus dados, quais são as
            regras do serviço e como mantemos tudo seguro.
          </p>
          {/* nav âncoras */}
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-sm text-mute">
                    Última atualização: {section.updated}
                  </p>
                </div>
              </div>
        ...
        <div className="mt-16 rounded-xl border border-line bg-card p-8 text-center">
          <p className="text-lg font-bold text-ink">
            Dúvidas sobre privacidade ou segurança?
          </p>

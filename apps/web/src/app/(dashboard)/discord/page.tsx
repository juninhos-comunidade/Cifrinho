  ...
  return (
    <div className="mx-auto max-w-3xl space-y-5">
      ...
      <div
        ...
        style={{ background: 'linear-gradient(135deg, rgb(var(--c-card)) 60%, rgb(88 101 242 / 0.12))' }}
      >
        <div className="flex flex-col items-center gap-5 sm:flex-row sm:items-start">
          {/* logo Discord SVG */}
          <div className="grid h-20 w-20 shrink-0 place-items-center rounded-2xl" style={{ backgroundColor: '#5865F2' }}>
          ...
          <div className="flex-1 text-center sm:text-left">
            <p className="text-xs font-bold uppercase tracking-widest" style={{ color: '#5865F2' }}>Comunidade oficial</p>
            ...
            <p className="mt-2 text-sm text-mute leading-relaxed">
              Faça parte da nossa comunidade de educação financeira. Tire dúvidas, compartilhe conquistas e ajude outros brasileiros a organizarem suas finanças.
            </p>
            <div className="mt-4 flex flex-col items-center gap-3 sm:flex-row sm:items-start">
              ...
              <div className="flex items-center gap-1.5 text-sm text-mute">
                ...
                <span><strong className="text-ink">2.400+</strong> membros</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="rounded-xl border border-line bg-card p-6 elev-sm">
        ...
        <p className="text-xs text-mute">Cada canal tem um foco específico para facilitar as conversas</p>
        <div className="mt-5 space-y-3">
          {CHANNELS.map((ch) => (
            <div key={ch.name} className="flex items-start gap-4 rounded-lg border border-line bg-bg p-4">
      ...
      <div className="rounded-xl border border-line bg-card p-6 elev-sm">
        ...
        <div className="mt-5 grid gap-4 sm:grid-cols-2">
          {BENEFITS.map((b) => (
            <div key={b.title} className="flex items-start gap-3 rounded-lg border border-line bg-bg p-4">
              <span
                className="grid h-9 w-9 shrink-0 place-items-center rounded-md"
                style={{ backgroundColor: 'rgb(88 101 242 / 0.12)', color: '#5865F2' }}
              >
                {b.icon}
              </span>
              <div>
      ...
      <div
        ...
        style={{ background: 'linear-gradient(135deg, rgb(88 101 242 / 0.08), rgb(88 101 242 / 0.03))' }}
      >

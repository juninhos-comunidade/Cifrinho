        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 pt-16 pb-20 sm:px-8 md:pt-24 md:pb-28 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="mx-auto mt-6 max-w-xl text-lg leading-relaxed text-mute lg:mx-0">
              O Cifrinho organiza despesas, receitas e dados fiscais com
              inteligência — e ainda deixa seu Imposto de Renda pronto antes da
              hora. Gestão híbrida de verdade.
            </p>
        ...
        <div className="mx-auto max-w-7xl border-t border-line/60 px-5 py-7 sm:px-8">
          <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-3 text-center text-sm text-mute">
            <span className="font-semibold text-ink">
              Confiado por quem leva grana a sério:
            </span>
      ...
      >
        <ScrollReveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-mute">
            Gestão pessoal, controle empresarial e Imposto de Renda —
            integrados, sem precisar pular entre planilhas e apps.
          </p>
        </ScrollReveal>
          ...
          <div className="grid items-center gap-14 lg:grid-cols-[0.9fr_1.1fr]">
            <ScrollReveal>
              ...
              <p className="mt-5 text-lg leading-relaxed text-mute">
                Cada hábito financeiro saudável desbloqueia uma badge. Mantenha
                sequências, suba de nível e acompanhe seu progresso junto com o
                squad da Comunidade Juninhos.
              </p>
        ...
        <ScrollReveal>
          <div className="relative overflow-hidden rounded-xl border border-line bg-card px-6 py-14 text-center sm:px-12 md:py-20">
            ...
            <p className="relative mx-auto mt-4 max-w-lg text-lg text-mute">
              Gratuito para começar. Sem cartão, sem complicação — só clareza
          ...
          <div className="grid gap-10 md:grid-cols-[1.5fr_1fr_1fr_1fr]">
            <div>
              ...
              <p className="mt-4 max-w-xs text-sm leading-relaxed text-mute">
                Ecossistema inteligente de gestão financeira híbrida — pessoal,

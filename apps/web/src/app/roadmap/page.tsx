...
const FALLBACK: RoadmapPayload = {
  planned: [
    {
      id: 0,
      name: "2FA",
      detail: "Autenticação de dois fatores",
      area: ["Back-end"],
      status: "planned",
      github_url: "#",
    },
    {
      id: 0,
      name: "Open Banking",
      detail: "Conexão direta com bancos",
      area: ["API"],
      status: "planned",
      github_url: "#",
    },
    ...
    },
    {
      ...
      detail: "Relatórios para download",
      area: ["Back-end"],
      status: "planned",
      github_url: "#",
    },
  ...
  in_progress: [
    {
      id: 0,
      name: "Integração API real",
      detail: "Conectando dashboard aos dados reais",
    ...
    },
    {
      ...
      detail: "Base de conhecimento e suporte",
      area: ["Front-end"],
      status: "in_progress",
      github_url: "#",
    },
    ...
    },
    {
      id: 0,
      name: "Dashboard",
      detail: "Painel financeiro pessoal",
      area: ["Front-end"],
      status: "done",
      github_url: "#",
    },
    {
      id: 0,
      name: "Gestão Pessoal",
      detail: "Controle de despesas e receitas",
      area: ["Front-end", "Back-end"],
      status: "done",
      github_url: "#",
    },
    ...
    },
    {
      ...
      detail: "Declaração anual automatizada",
      area: ["Back-end", "Front-end"],
      status: "done",
      github_url: "#",
    },
    ...
    },
    {
      id: 0,
      name: "Página Legal",
      detail: "Termos, privacidade e cookies",
      area: ["Front-end"],
      status: "done",
      github_url: "#",
    },
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <p
          className="mt-[3px] text-xs leading-snug"
    ...
    >
      ...
      <header className="mx-auto w-full max-w-3xl shrink-0 px-6 pt-9 text-center">
        ...
        <p className="mx-auto mt-2 max-w-xl text-sm leading-relaxed text-mute">
          Acompanhe o que está sendo construído, o que vem a seguir e o que já
          foi entregue.
        </p>
        ...
        <div className="mx-auto mt-6 max-w-xl">
          <div className="mb-2 flex items-center justify-between text-xs font-semibold">
            ...
            <span className="text-ink">
              <span className="text-brand">{meta.pct}%</span> ·{" "}
              {meta.done_count} de {meta.total} features entregues
            </span>
          </div>
          <div
            ...
            style={{
              background: "rgb(var(--c-card))",
              boxShadow: "0 0 0 1px rgb(var(--c-line))",
            }}
          >
            <div
              ...
              style={{
                width: `${meta.pct}%`,
                background: "linear-gradient(90deg,#21C25E,#3B82F6)",
              }}
            />
          </div>
        </div>
      ...
      <div className="mx-auto grid w-full max-w-[1280px] flex-1 grid-cols-1 gap-5 overflow-hidden p-6 md:grid-cols-3">
        ...
        >
          <div className="flex shrink-0 flex-col items-center text-center">
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle at 50% 45%, rgb(var(--c-blue) / 0.20), rgb(var(--c-blue) / 0.05) 70%)",
            ...
            >
              ...
              <span
                ...
                style={{
                  background: "#3B82F6",
                  boxShadow: "0 6px 16px -2px rgba(59,130,246,.55)",
                }}
              >
                {SVG_CLOCK}
              </span>
            ...
            <p className="mt-0.5 text-xs font-medium text-blue">
              Aguardando · {planned.length} itens
            </p>
          </div>
          <div
            className="mt-5 flex min-h-0 flex-1 flex-col gap-2.5 overflow-y-auto"
        ...
        <section
          className="flex min-h-0 flex-col rounded-2xl p-5"
          style={{
            background: "rgb(var(--c-amber) / 0.06)",
            border: "1px solid rgb(var(--c-amber) / 0.18)",
          }}
        >
          <div className="flex shrink-0 flex-col items-center text-center">
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle at 50% 45%, rgb(var(--c-amber) / 0.20), rgb(var(--c-amber) / 0.05) 70%)",
            ...
            <p className="mt-0.5 text-xs font-medium text-amber">
              Trabalhando · {in_progress.length} itens
            </p>
          </div>
          <div
            className="mt-5 flex min-h-0 flex-1 flex-col gap-2.5 overflow-y-auto"
        ...
        <section
          ...
          style={{
            ...
            border: "1px solid rgb(var(--c-brand) / 0.18)",
          }}
        >
          <div className="flex shrink-0 flex-col items-center text-center">
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle at 50% 45%, rgb(var(--c-brand) / 0.20), rgb(var(--c-brand) / 0.05) 70%)",
            ...
            >
              <Image
                ...
                style={{
                  objectFit: "contain",
                  filter: "drop-shadow(0 0 12px rgb(var(--c-brand) / 0.45))",
                }}
              />
              <span
                className="absolute -right-1.5 -top-1.5 flex h-10 w-10 items-center justify-center rounded-full text-white"
                style={{
                  background: "#21C25E",
                  boxShadow: "0 6px 16px -2px rgba(33,194,94,.55)",
                }}
              >
                {SVG_CHECK}
              </span>

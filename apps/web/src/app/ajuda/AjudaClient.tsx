      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-3xl px-5 py-16 text-center sm:px-8 md:py-24">
          ...
          <p
            ...
            style={{ color: "#9CA3AF" }}
          >
            Busque artigos, explore categorias ou confira as perguntas mais
            frequentes.
          </p>
        ...
        >
          ...
          <div className="relative">
            ...
            <p
              ...
              style={{ color: "#9CA3AF" }}
            >
              Nossa equipe está pronta para ajudar. Respondemos em até 2 dias
              úteis.
            </p>

...
const COPY: Record<
  ServiceStatus,
  { badge: string; title: ReactNode; sub: string; uptime: string; services: string }
> = {
  operational: {
...
export default async function StatusPage() {
  ...
  return (
    <div className="min-h-screen font-sans" style={{ backgroundColor: 'rgb(var(--c-bg-deep))' }}>
      <div
        className="mx-auto max-w-7xl overflow-hidden rounded-none border-0 sm:m-4 sm:rounded-2xl sm:border"
      ...
      >
        ...
        {/* 3-COLUMN BODY */}
        <div className="grid gap-6 p-4 sm:p-6 lg:grid-cols-[3fr_4fr_3fr]">
          {/* LEFT: HERO */}
          <div
          ...
          >
            ...
            <h1 className="mt-5 text-[1.75rem] font-extrabold leading-[1.08] tracking-tight text-ink lg:text-[2rem] lg:whitespace-nowrap">
              {copy.title}
            </h1>

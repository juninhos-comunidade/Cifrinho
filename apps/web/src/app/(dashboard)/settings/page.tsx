        ...
        <div className="p-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-mute">
                Todos os seus dados — transações, categorias, badges e
                configurações — serão excluídos de forma irreversível.
              </p>
            </div>
          </div>
          ...
          <div className="mt-5">
            <label className="text-xs font-semibold text-mute">
              Digite <span className="font-bold text-rose">ENCERRAR</span> para
              confirmar
            </label>
            <input
    ...
    <div className="mx-auto max-w-3xl space-y-5">
      ...
      <div className="rounded-lg border border-line bg-card p-6 elev-sm">
        ...
        <p className="text-xs text-mute">
          Ative ou desative módulos do dashboard
        </p>
        <div className="mt-4 divide-y divide-line">
          <div className="flex items-center justify-between py-3.5">
            <div>
              <p className="text-sm font-semibold text-ink">
                Conta empresarial (MEI / PJ)
              </p>
              <p className="text-xs text-mute">
                Exibe o módulo Empresarial e a opção "Empresarial" nos
                lançamentos
              </p>
            </div>
        ...
        <div className="mt-4 divide-y divide-line">
          <div className="flex items-center justify-between py-3.5">
            <div>
              ...
              <p className="text-xs text-mute">
                Proteja o acesso com um código extra
              </p>
            </div>
            <Toggle defaultOn />
          </div>

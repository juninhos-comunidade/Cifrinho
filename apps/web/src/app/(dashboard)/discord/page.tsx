  ...
  return (
    <div className="mx-auto max-w-3xl space-y-5">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgb(var(--c-card)) 60%, rgb(88 101 242 / 0.12))",
        }}
      >
        <div className="flex flex-col items-center gap-5 sm:flex-row sm:items-start">
          ...
          <div className="flex-1 text-center sm:text-left">
            ...
            <p className="mt-2 text-sm text-mute leading-relaxed">
              Faça parte da nossa comunidade de educação financeira. Tire
              dúvidas, compartilhe conquistas e ajude outros brasileiros a
      ...
      <div className="rounded-xl border border-line bg-card p-6 elev-sm">
        ...
        <p className="text-xs text-mute">
          Vantagens exclusivas para membros da comunidade
        </p>
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgb(88 101 242 / 0.08), rgb(88 101 242 / 0.03))",
        }}
      >
        <p className="text-base font-bold text-ink">Pronto para fazer parte?</p>
        <p className="mt-1 text-sm text-mute">
          É gratuito e leva menos de 1 minuto para entrar.
        </p>
        <a
          href="https://discord.gg/juninhos"
          target="_blank"

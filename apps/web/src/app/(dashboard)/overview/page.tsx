      ...
      <div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          {kpis.map((kpi, i) => (
            <div
              key={i}
              className="min-w-0 rounded-lg border border-line bg-card p-5 elev-sm"
              {...(i === 0 ? { 'data-onboarding': 'kpi-balance' } : {})}
            >
            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-4 text-xs text-ink">
                <span className="flex items-center gap-1.5">
                  <span className="h-2.5 w-2.5 rounded-sm bg-brand"></span>Receitas
                </span>
                <span className="flex items-center gap-1.5">
                  <span className="h-2.5 w-2.5 rounded-sm bg-line"></span>Despesas
                </span>
              </div>
            </div>
        ...
        {/* transações recentes */}
        <div className="mt-5 grid gap-5 lg:grid-cols-[1.6fr_1fr]">
          <div className="min-w-0 rounded-lg border border-line bg-card elev-sm">
          ...
          <div className="space-y-5">
            {/* metas ativas */}
            <div
              data-onboarding="card-goals"
              className="rounded-lg border border-line bg-card p-6 elev-sm"
            >
              <div className="flex items-center justify-between">
                <div>

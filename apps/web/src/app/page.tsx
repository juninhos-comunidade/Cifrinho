...
const BADGES = [
  {
    file: 'Primeiros passos.png',
    title: 'Primeiros Passos',
    sub: 'Salvou a 1ª meta',
    color: '#21C25E',
    bg: 'rgba(33,194,94,0.15)',
  },
  {
    file: 'Organizado.png',
    title: 'Organizado',
    sub: '30 dias categorizando',
    color: '#3B82F6',
  ...
  },
  {
    file: 'Declarante.png',
    title: 'IR em Dia',
    sub: 'Declaração pronta',
    color: '#8B5CF6',
    bg: 'rgba(139,92,246,0.15)',
  },
  {
    file: 'Economizador.png',
    title: 'Economizador',
    sub: '7 dias seguidos',
    color: '#21C25E',
    bg: 'rgba(33,194,94,0.15)',
    ...
    >
      ...
      <header className="sticky top-0 z-50 border-b border-line/70 bg-bg/80 backdrop-blur-xl">
        <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 sm:px-8">
          ...
          <div className="flex items-center gap-2.5">
            <Link
              href="/login"
              className="hidden rounded-md px-4 py-2 text-sm font-semibold text-mute transition-colors hover:text-ink sm:block"
            >
              Entrar
            </Link>
            <Link
              href="/login"
              className="rounded-md px-4 py-2 text-sm font-bold text-bg shadow-lg transition-all duration-200 hover:opacity-90"
      ...
      <section className="relative overflow-hidden">
        <div
          ...
          style={{
            background: 'radial-gradient(circle at 50% 0%, rgba(33,194,94,0.18), transparent 60%)',
          }}
        />
        <div
          className="pointer-events-none absolute inset-0 -z-10 h-[120%]"
          style={{
            backgroundImage:
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 pt-16 pb-20 sm:px-8 md:pt-24 md:pb-28 lg:grid-cols-[1.05fr_0.95fr]">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-4xl font-extrabold leading-tight tracking-tight sm:text-5xl md:text-6xl text-ink">
              ...
              <span style={{ color: '#21C25E' }}>pessoal e empresarial</span>
              <br className="hidden sm:block" />
              no mesmo lugar.
            </h1>
            <p className="mx-auto mt-6 max-w-xl text-lg leading-relaxed text-mute lg:mx-0">
              O Cifrinho organiza despesas, receitas e dados fiscais com inteligência — e ainda
              deixa seu Imposto de Renda pronto antes da hora. Gestão híbrida de verdade.
            </p>
            <div className="mt-9 flex flex-col items-center gap-3 sm:flex-row lg:justify-start sm:justify-center">
              <Link
                ...
                style={{
                  ...
                  boxShadow: '0 20px 40px -10px rgba(33,194,94,0.25)',
                }}
              >
              ...
              <a
                href="#recursos"
                className="flex w-full items-center justify-center gap-2 rounded-md border border-line bg-card px-7 py-3.5 text-base font-semibold text-ink transition-colors hover:border-mute/40 sm:w-auto"
              >
                Ver recursos
              </a>
            </div>
          ...
          <div className="relative">
            <div
              ...
              style={{ backgroundColor: 'rgba(33,194,94,0.1)' }}
            />
            <div className="relative mx-auto max-w-md rounded-xl border border-line bg-card/80 p-6 shadow-2xl backdrop-blur">
              <div className="mb-5 flex items-center justify-between">
                ...
                <span
                  className="rounded-full border border-line bg-bg px-2.5 py-1 text-[11px] font-semibold"
                  style={{ color: '#21C25E' }}
                >
                  Maio
                </span>
              ...
              <p className="text-3xl font-extrabold tracking-tight text-ink">
                R$ 24.780<span className="text-mute">,50</span>
              </p>
              <div
                ...
                {[42, 58, 48, 72, 96, 64].map((h, i) => (
                  <div
                    ...
                    style={{
                      height: `${h}%`,
                      backgroundColor:
                        i === 4 ? '#21C25E' : i === 2 ? 'rgba(59,130,246,0.6)' : '#1F2937',
                    }}
                  />
                ))}
              </div>
      ...
      <section id="recursos" className="mx-auto max-w-7xl px-5 py-20 sm:px-8 md:py-28">
        <ScrollReveal className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl md:text-5xl text-ink">
            Um ecossistema, três frentes
          </h2>
          <p className="mt-4 text-lg text-mute">
            Gestão pessoal, controle empresarial e Imposto de Renda — integrados, sem precisar pular
            entre planilhas e apps.
          </p>
        </ScrollReveal>
        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {[
            ...
            },
            {
              ...
              items: [
                'Triagem de comprovantes',
                'Cálculo estimado de deduções',
                'Dados prontos para declarar',
              ],
            },
          ].map(({ delay, accent, accentBg, hoverBorder, icon, title, desc, items }) => (
            <ScrollReveal key={title} delay={delay}>
              <article
                id={title === 'Imposto de Renda' ? 'imposto' : undefined}
              ...
              >
                <div
                  className="mb-5 grid h-12 w-12 place-items-center rounded-md"
      ...
      <section
        id="badges"
        className="relative overflow-hidden border-y border-line/60 py-20 md:py-28"
        style={{ backgroundColor: 'rgba(17,24,39,0.3)' }}
      >
        <div
          className="pointer-events-none absolute inset-x-0 top-0 -z-10 h-1/2 opacity-60"
          style={{
            background: 'radial-gradient(circle at 50% 0%, rgba(33,194,94,0.18), transparent 60%)',
          }}
        />
          ...
          <div className="grid items-center gap-14 lg:grid-cols-[0.9fr_1.1fr]">
            <ScrollReveal>
              ...
              <p className="mt-5 text-lg leading-relaxed text-mute">
                Cada hábito financeiro saudável desbloqueia uma badge. Mantenha sequências, suba de
                nível e acompanhe seu progresso junto com o squad da Comunidade Juninhos.
              </p>
              <div className="mt-8 flex items-center gap-5">
                <div>
                  <p className="text-3xl font-extrabold" style={{ color: '#21C25E' }}>
                    Nível 7
                  </p>
              ...
              <div className="mt-7 max-w-sm">
                ...
                <div className="h-2.5 w-full overflow-hidden rounded-full bg-bg">
                  <div
                    ...
                    style={{
                      width: '74%',
                      background: 'linear-gradient(to right, #21C25E, #3B82F6)',
                    }}
                  />
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">
              {BADGES.map(({ file, title, sub, color: _color, bg }, i) => (
              ...
              <ScrollReveal delay={BADGES.length * 80}>
                <div
                  className="h-full rounded-lg border border-dashed border-line p-5 text-center opacity-60"
        ...
        <ScrollReveal>
          <div className="relative overflow-hidden rounded-xl border border-line bg-card px-6 py-14 text-center sm:px-12 md:py-20">
            <div
              ...
              style={{
                background:
                  'radial-gradient(circle at 50% 0%, rgba(33,194,94,0.18), transparent 60%)',
              }}
            />
            <Image
              src="/cifrinho-mascot.png"
              ...
              width={96}
              height={96}
              className="relative mx-auto mb-6 rounded-full"
              style={{ animation: 'float 6s ease-in-out infinite' }}
            />
            <h2 className="relative mx-auto max-w-2xl text-3xl font-extrabold tracking-tight sm:text-4xl md:text-5xl text-ink">
              Comece a organizar seu cifrinho hoje
            </h2>
            <p className="relative mx-auto mt-4 max-w-lg text-lg text-mute">
              Gratuito para começar. Sem cartão, sem complicação — só clareza financeira de verdade.
            </p>
            <div className="relative mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              <a
                href="#recursos"
                className="flex w-full items-center justify-center rounded-md border border-line bg-bg px-8 py-3.5 text-base font-semibold text-ink transition-colors hover:border-mute/40 sm:w-auto"
              >
                Ver recursos
              </a>
            </div>
          ...
          <div className="grid gap-10 md:grid-cols-[1.5fr_1fr_1fr_1fr]">
            <div>
              ...
              <p className="mt-4 max-w-xs text-sm leading-relaxed text-mute">
                Ecossistema inteligente de gestão financeira híbrida — pessoal, empresarial e
                fiscal.
              </p>
              <a
                href="https://www.juninhos.com/"
            ...
            <div>
              ...
              <ul className="mt-4 space-y-3 text-sm text-mute">
                ...
                <li>
                  <a href="#imposto" className="transition-colors hover:text-ink">
                    Imposto de Renda
                  </a>
                </li>
                <li>
                  <a href="#badges" className="transition-colors hover:text-ink">
                    Gamificação
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-3 text-sm text-mute">
                <li>
                  <a href="/ajuda" className="transition-colors hover:text-ink">
                    Central de ajuda
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="/discord" className="transition-colors hover:text-ink">
                    Discord
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-3 text-sm text-mute">
                <li>
                  <a href="/legal#privacidade" className="transition-colors hover:text-ink">
                    Privacidade
                  </a>
                </li>
                <li>
                  <a href="/legal#termos" className="transition-colors hover:text-ink">
                    Termos
                  </a>
                </li>
                <li>
                  <a href="/legal#seguranca" className="transition-colors hover:text-ink">
                    Segurança
                  </a>
                </li>
              </ul>
